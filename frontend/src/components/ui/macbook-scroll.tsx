...
import mainImage from "../../assets/Images/ImageMain.png";
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        <img src={mainImage} alt="aceternity logo" className="object-cover object-left-top absolute rounded-lg inset-0 h-full w-full" />
